      ...
      ...(sentryUpload
        ? [
            sentryVitePlugin({
              ...
              telemetry: false,
              sourcemaps: {
                // Limit upload candidates to compiled app bundles to avoid noisy sourcemap auto-detection
                // warnings from non-app artifacts generated by other plugins/build steps.
                assets: ['./dist/assets/**/*.{js,mjs,js.map,mjs.map}'],
                ignore: ['**/workbox-*.js', '**/sw.js'],
              },
              release: {
