      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-transparent border border-surface-border text-content-secondary px-4 py-2 rounded-md text-sm font-medium hover:bg-surface-elevated transition-colors"
          >
      ...
      <CollapsibleModule title="Financial Summary" icon={OverviewIcon}>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 -mx-6 -my-6 p-6">
          {[
            ...
            <div key={card.label} className="bg-surface-elevated border border-surface-border rounded-xl p-5">
      ...
      <CollapsibleModule title="Spending Recaps" icon={CalendarIcon}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 -mx-6 -my-6 p-6">
          {[
            ...
            <div key={label} className="bg-surface-elevated border border-surface-border rounded-xl p-5">
