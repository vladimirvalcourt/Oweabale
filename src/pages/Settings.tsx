                  ...
                  <div className="border border-[#262626] rounded-md p-4 flex items-center justify-between mb-4">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-[#1C1C1C] rounded flex items-center justify-center border border-[#262626]">
                        <span className="text-zinc-300 font-bold text-lg">C</span>
                      </div>
                      <div>
                        <p className="text-sm font-medium text-[#FAFAFA]">Chase Bank</p>
                        <p className="text-xs text-zinc-500">Checking •••• 1234</p>
                      </div>
                    </div>
                    <span className="text-xs font-medium text-[#22C55E] border border-[#262626] px-2 py-1 rounded-full">Connected</span>
                  </div>
                  <button onClick={() => toast.info('Plaid integration opening...')} className="text-sm font-medium text-indigo-500 hover:text-indigo-400 transition-colors flex items-center gap-2">
