    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs font-mono uppercase tracking-widest text-content-tertiary mt-1">Account configuration & preferences</p>
        </div>
          ...
          {activeTab === 'profile' && (
            <>
              ...
              <CollapsibleModule 
                ...
                icon={User}
                extraHeader={<span className="text-[10px] font-mono text-content-tertiary uppercase tracking-widest">{user.firstName} {user.lastName} VERIFIED</span>}
              >
                  ...
                  <form onSubmit={handleProfileSubmit} className="space-y-6">
                    <div className="flex items-center gap-6 pb-6 border-b border-surface-border">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[9px] font-mono text-content-muted shadow-none uppercase tracking-widest block pt-2">User ID: OWE_{user.id?.substring(0, 8)}</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-surface-border bg-surface-elevated/50 rounded-sm">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-content-tertiary">Signed in as {user.email}</p>
                      </div>
                    </div>
          ...
          {activeTab === 'billing' && (
            <div className="space-y-6">
              <CollapsibleModule 
                ...
                icon={Building2} 
                defaultOpen={true}
                extraHeader={<span className="inline-flex items-center text-[10px] font-mono font-bold text-content-tertiary bg-surface-raised px-2.5 py-1 rounded-sm border border-surface-border uppercase tracking-widest">The Tracker</span>}
              >
          ...
          {activeTab === 'financial' && (
            <div className="space-y-6">
              ...
              <CollapsibleModule title="Budget Limits" icon={PieChart} defaultOpen={false}>
                <p className="text-sm text-content-tertiary mb-6">Set global budget limits to receive alerts when you're close to overspending.</p>
                <div className="space-y-4 max-w-md">
                  <div>
              ...
              <CollapsibleModule title="Tax & Export" icon={FileText} defaultOpen={false}>
                ...
                <div className="space-y-4">
                  <div className="border border-surface-border rounded-sm p-4 flex items-center justify-between bg-surface-elevated/50">
                    ...
                    <button onClick={() => toast.success('TurboTax integration initiated')} className="text-[10px] font-mono font-bold uppercase tracking-widest text-content-secondary hover:text-white bg-surface-raised border border-surface-border hover:bg-surface-elevated px-3 py-1.5 rounded-sm transition-colors">
                      Connect
                    </button>
                  </div>
                  <div className="border border-surface-border rounded-sm p-4 flex items-center justify-between bg-surface-elevated/50">
                    ...
                    <button onClick={() => toast.success('Google Sheets sync initiated')} className="text-[10px] font-mono font-bold uppercase tracking-widest text-content-secondary hover:text-white bg-surface-raised border border-surface-border hover:bg-surface-elevated px-3 py-1.5 rounded-sm transition-colors">
                      Connect
                    </button>
                  </div>
                </div>
                ...
                <div className="-mx-6 -my-6 p-6 bg-surface-base">
                  <form onSubmit={handleSubmitTicket} className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-[10px] font-mono font-bold text-content-tertiary uppercase tracking-widest mb-2">Category</label>
                        <select
              ...
              <CollapsibleModule title="Share Your Feedback" icon={ThumbsUp}>
                <div className="-mx-6 -my-6 p-6 bg-surface-base">
                  <form onSubmit={handleSubmitFeedback} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        <label className="block text-[10px] font-mono font-bold text-content-tertiary uppercase tracking-widest mb-2">Type</label>
                        <select
                      ...
                      <div>
                        <label className="block text-[10px] font-mono font-bold text-content-tertiary uppercase tracking-widest mb-2">Rating (optional)</label>
                    ...
                    <div>
                      <label className="block text-[10px] font-mono font-bold text-content-tertiary uppercase tracking-widest mb-2">Your Message</label>
                      <textarea
