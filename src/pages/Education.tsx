                            ...
                            >
                              ...
                              <div className="mt-4">
                                ...
                                <div className="h-1 w-full bg-surface-base overflow-hidden rounded-full">
                                  <div 
                                    className={`h-full ${mod.progress === 100 ? 'bg-emerald-500' : 'bg-indigo-500'}`} 
                ...
                <div className="space-y-4">
                    ...
                    {activeModule.lessons.map((lesson, idx) => (
                      ...
                      >
                        <div className="flex items-center gap-4">
                          <div className={`p-1.5 rounded-sm ${activeModule.progress === 100 ? 'text-emerald-500' : 'text-zinc-500 group-hover:text-white transition-colors'}`}>
                            {activeModule.progress === 100 ? <CheckCircle2 className="w-5 h-5" /> : <FileText className="w-5 h-5" />}
                          </div>
                          <div>
                  ...
                  <div className="mt-8 pt-6 border-t border-surface-border flex justify-end">
                    ...
                    >
                       ...
                       {activeModule.progress === 0 ? 'START COURSE' : activeModule.progress === 100 ? 'REVIEW COURSE' : 'RESUME COURSE'}
                    </button>
                  </div>
                </div>
              </div>
