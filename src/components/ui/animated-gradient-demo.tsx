    ...
    >
      <div className="text-content-primary text-center space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button className="px-3 py-2 bg-red-600 hover:bg-red-500 rounded-lg transition-colors text-[10px] font-bold uppercase tracking-widest">
            <Shield className="w-4 h-4 inline mr-1" />
            Secure
          </button>
          <button className="px-3 py-2 border border-red-400 hover:border-red-300 rounded-lg transition-colors text-[10px] font-bold uppercase tracking-widest">
    ...
    >
      <div className="text-content-primary text-center space-y-4">
        ...
        <div className="flex flex-col gap-2">
          <button className="px-4 py-2 bg-green-600 hover:bg-green-500 rounded-lg transition-all text-[10px] font-bold uppercase tracking-widest">
