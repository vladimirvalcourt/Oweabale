...
CREATE TABLE IF NOT EXISTS profiles (
  ...
  tax_reserve_percent NUMERIC(5, 2) NOT NULL DEFAULT 30
    CHECK (tax_reserve_percent >= 0 AND tax_reserve_percent <= 100),
  steady_salary_target NUMERIC(14, 2) NOT NULL DEFAULT 0
    CHECK (steady_salary_target >= 0),
  alert_preferences JSONB NOT NULL DEFAULT '{"bill_due_days":[1,3],"over_budget":true,"low_cash":true,"debt_due":true}'::jsonb,
